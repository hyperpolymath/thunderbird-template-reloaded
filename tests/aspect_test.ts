...
//
// Aspect tests verify cross-cutting concerns that span multiple modules:
// security policy, accessibility of public documentation, editorconfig
// consistency, and no banned file patterns.
...
// ---------------------------------------------------------------------------
// Aspect: No TypeScript without Deno (no tsconfig / tsc usage)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Aspect: All test files in tests/ are valid Deno TypeScript (has Deno.test)
// ---------------------------------------------------------------------------
