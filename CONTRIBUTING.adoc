...
git clone
https://github.com/hyperpolymath/thunderbird-template-reloaded.git cd
...
toolbox create thunderbird-template-reloaded-dev toolbox enter
thunderbird-template-reloaded-dev # Install dependencies manually
...
thunderbird-template-reloaded/ ├── src/ # Source code (Perimeter 1-2)
