...
// Replace thunderbird-template-reloaded, Thunderbird Template Reloaded — See README.adoc for details., just run, Thunderbird Template Reloaded started successfully. with actuals
= thunderbird-template-reloaded — Quick Start for Users
:toc:
:toclevels: 2

== What is thunderbird-template-reloaded?

Thunderbird Template Reloaded — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./thunderbird-template-reloaded-portable
----
...
[source]
----
Thunderbird Template Reloaded started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/thunderbird-template-reloaded/wiki
