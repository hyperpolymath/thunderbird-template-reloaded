{
  description = "thunderbird-template-reloaded - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 thunderbird-template-reloaded development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          pname = "thunderbird-template-reloaded";
          version = "0.1.0";
          src = ./.;
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P thunderbird-template-reloaded.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/thunderbird-template-reloaded $out/bin/  # Rust
            # cp bin/thunderbird-template-reloaded $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/thunderbird-template-reloaded";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-thunderbird-template-reloaded" {
